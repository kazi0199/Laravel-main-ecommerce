              ...
              <tr>
                ...
                <td>
                  <div class="qty-control position-relative">
                    ...
                    <form action="{{ route('increase.cart.quantity',$item->rowId ) }}" method="POST">
                        @csrf
                        <div class="qty-control__increase">+</div>
                    </form>

                    <form action="{{ route('decrease.cart.quantity', $item->rowId ) }}" method="POST">
                        @csrf
                ...
                <td>
                  ...
                  <form action="{{ route('cart.item.remove',$item->rowId) }}" method="POST" class="remove-cart">
                    @csrf
                    @method('DELETE')
