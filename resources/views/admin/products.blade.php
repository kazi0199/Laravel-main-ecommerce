                                ...
                                <tr>
                                    ...
                                    <td class="pname">
                                        <div class="image">
                                            ...
                                            {{-- <img src="{{ asset('uploads/products/public/thumbnails') }}/{{ $product->image }}" alt="" class="image"> --}}
                                        </div>
                                        <div class="name">
                                    ...
                                    <td>{{ optional($product->brand)->name ?? 'No Brand' }}</td>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            ...
                                            {{-- <a href="{{ route('admin.products.delete',$brand->id) }}" onclick="return confirm('Are you sure to delete this!')">
