...
<div class="main-content-inner">
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            <h3>Product Edit Information</h3>
                ...
                <div class="wg-box">
                    ...
                    <div class="gap22 cols">
                        <fieldset class="category">
                            ...
                            <div class="select">
                                <select class="" value="{{ $product->category_id }}" name="category_id">
                    ...
                    <fieldset class="shortdescription">
                        <div class="body-title mb-10">Short Description <span class="tf-color-1">*</span>
                        </div>
                    ...
                    <div class="cols gap22">
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="stock_status" value="{{ $product->stock_status }}">
