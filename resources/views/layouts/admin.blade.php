    ...
    $("#admin-search-input").on("keyup", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.length === 0) {
                    $("#box-content-search ul").append(
                        `<li class="px-3 py-2">No product found</li>`
                    );
                    return;
                }
                ...
                $.each(data, function (i, item) {
                    ...
                    let link = "/admin/products/edit/" + item.id;

                    $("#box-content-search ul").append(`
                        <li class="product-item gap14 mb-10">
                            <div class="image no-bg">
                                <img src="/uploads/products/${item.image}" width="40">
                            </div>
                            <div class="name">
